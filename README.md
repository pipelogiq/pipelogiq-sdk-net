...
![Status: Preview v0.3.0-preview.3](https://img.shields.io/badge/status-Preview%20v0.3.0--preview.3-orange)

Pipelogiq .NET SDK provides the .NET worker runtime and API client helpers for Pipelogiq pipelines.
This repository is currently shipping **v0.3.0-preview.3** packages focused on execution, transport, integration primitives, and AI agent workflows.
